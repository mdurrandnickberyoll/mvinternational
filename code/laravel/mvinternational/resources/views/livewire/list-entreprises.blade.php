            ...
            <div class="card">
                <div class="card-header border-bottom-0 p-4">
                    ...
                    <div class="page-options d-flex float-end">
                        <a class="btn btn-primary mb-4" href="{{ route('entreprise') }}"> Ajouter une ligne</a>
                    </div>
                </div>
                                    ...
                                    @foreach ($datas as $item)
                                        <tr>
                                            ...
                                            <td class="text-nowrap align-middle">
                                                <p style="max-width: 200px;overflow: hidden;text-overflow: ellipsis; white-space: nowrap;">{{ $item->description}}</p>
                                            </td>

                                            <td class="text-center align-middle">
                                                <div class="btn-group align-top">
                                                    <a class="btn btn-sm btn-primary badge"
                                                        href="{{ route('entreprise_show', [$item->id]) }}"
                                            ...
                                            <td class="text-center align-middle">
                                                <div class="btn-group align-top">
                                                    <a class="btn btn-sm btn-primary badge"
                                                        href="{{ route('entreprise_edit', [$item->id]) }}"
                                                        type="button"><i class="fa fa-edit"></i></a>
                                                    <a class="btn btn-sm btn-primary badge"
                                                        href="{{ route('entreprise_del', [$item->id, 'supp']) }}"
