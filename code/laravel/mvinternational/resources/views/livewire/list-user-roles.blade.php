            ...
            <div class="card">
                <div class="card-header border-bottom-0 p-4">
                    <h2 class="card-title ">   </h2>
                     ...
                     <a class="btn btn-primary mb-4" href="{{ route('user_role',[$user->id]) }}"> Ajouter une ligne</a> 
                     </div>
                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center align-middle">
                                                <div class="btn-group align-top">
                                                    <a class="btn btn-sm btn-primary badge" href="{{ route('user_role_edit', [$item->id]) }}" type="button"><i class="fa fa-edit"></i></a>
                                                    <a class="btn btn-sm btn-primary badge" href="{{ route('user_role_del', [$item->id, 'supp']) }}" type="button"><i class="fa fa-trash"></i></a>
                                                </div>
                                            </td> 
                                        </tr>
                                    @endforeach
