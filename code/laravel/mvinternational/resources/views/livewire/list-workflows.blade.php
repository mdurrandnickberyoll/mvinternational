            ...
            <div class="card">
                <div class="card-header border-bottom-0 p-4">
                    ...
                    <div class="page-options d-flex float-end">
                        <a class="btn btn-primary mb-4" href="{{ route('workflow') }}"> Ajouter une ligne</a>
                    </div>
                </div>
                        ...
                        <table class="table border-top table-bordered mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">Etapes</th>
                                </tr>
                            </thead>
                            <tbody>
                                @if (!empty($datas))
                                    @foreach ($datas as $item)
                                        <tr>
                                            ...
                                            <td class="text-nowrap align-middle">{{ $item->document->libelle }}</td>

                                            <td class="text-center align-middle">
                                                <div class="btn-group align-top">
                                                    <a class="btn btn-sm btn-primary badge" href="{{ route('workflow_edit', [$item->id]) }}" type="button"><i class="fa fa-edit"></i></a>
                                                    <a class="btn btn-sm btn-primary badge" href="{{ route('workflow_del', [$item->id, 'supp']) }}" type="button"><i class="fa fa-trash"></i></a>
                                                </div>
                                            </td>
                                            <td class="text-center align-middle">
                                                <div class="btn-group align-top">
                                                     <a class="btn btn-sm btn-primary badge" href="{{ route('etapes', [$item->id]) }}" type="button"><i class="fa fa-binoculars"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforeach
