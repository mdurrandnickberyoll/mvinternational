...
<div class="page-header">
    <h1 class="page-title">Formulaire de la pays</h1>
    <div>
        <ol class="breadcrumb">
...
<div class="col-lg-12 col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('pays_store') }}">
                    @csrf
                    <input type="hidden" name="id" class="form-control" @if(!empty($pays)) value="{{ $pays->id }}" @endif>
                    ...
                    <div class="form-row">
                        <div class="col-xl-6 mb-3">
                            ...
                            <input type="text" name="libelle" class="form-control" @if(!empty($pays)) value="{{ $pays->libelle }}" @endif id="validationDefault01" required>
                             <div class="mt-2">
                            @if($errors->any())
                    ...
                    <a class="btn btn-default" href="{{ route('payss') }}" >Annuler</a>
                </form>
            </div>
        </div>
    </div> 
